configure = {
    "name": "天津市公共资源交易平台-宝坻区-交易信息-政府采购-需求公示",
    "org_id": "1201895",
    ...
    "pagination": {
        "url": 'http://180.213.33.140:8081/content/pageContentM@$pageNo=${page_param}&count=10&orderBy=27&isNew=true&title=&projectType=&areaNo=宝坻区&inDate=&tenderProjectCode=&channelIds=@json:["82301"]&timeBegin=&timeEnd',
        "headers": {
            "Accept": "application/json, text/javascript, */*; q=0.01",
            "Accept-Language": "zh-CN,zh;q=0.9",
            "Content-Type": "application/json;charset=UTF-8",
...
entrance_url = 'http://180.213.33.140:8081/content/pageContentM@$pageNo=1&count=10&orderBy=27&isNew=true&title=&projectType=&areaNo=宝坻区&inDate=&tenderProjectCode=&channelIds=@json:["82301"]&timeBegin=&timeEnd'
