configure = {
    "name": "天津市公共资源交易平台-津南区-交易信息-行政事业性国有资产出售_出租-拍卖公告",
    "org_id": "1201892",
    "page_url": "http://180.213.33.140:8081/jyxx.jhtml",
    "host": "180.213.33.140",
    "source_site": "天津市公共资源交易平台",
    "industry": "行政事业性国有资产出售_出租",
    "notice_type": "拍卖公告",
    "list": {
        "mode": "REQUESTS",
        "method": "POST",
    ...
    "pagination": {
        "url": 'http://180.213.33.140:8081/content/pageContentM@$pageNo=${page_param}&count=10&orderBy=27&isNew=true&title=&projectType=&areaNo=津南区&inDate=&tenderProjectCode=&channelIds=@json:["82473"]&timeBegin=&timeEnd',
        "headers": {
            "Accept": "application/json, text/javascript, */*; q=0.01",
            "Accept-Language": "zh-CN,zh;q=0.9",
            "Content-Type": "application/json;charset=UTF-8",
...
entrance_url = 'http://180.213.33.140:8081/content/pageContentM@$pageNo=1&count=10&orderBy=27&isNew=true&title=&projectType=&areaNo=津南区&inDate=&tenderProjectCode=&channelIds=@json:["82473"]&timeBegin=&timeEnd'
